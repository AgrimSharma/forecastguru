...
class SocialAccount(models.Model):
    ...
    fg_points_free = models.IntegerField(default=10000)
    fg_points_bought = models.IntegerField(default=0)
    fg_points_won = models.IntegerField(default=0)
    fg_points_lost = models.IntegerField(default=0)
    fg_points_total = models.IntegerField(default=0)
    ...
    fg_status = models.CharField(max_length=100,default='Novice')
